---
title: 'R beginner tutorial: part 2'
author: "@SarfarazAlam"
output: 
  html_document: 
    toc: TRUE
...
```{r factor, fig.width=4, fig.height=3,fig.show='hold',fig.align='center'}
...
I will show two ways to select part of a dataframe that follow user-specified condition. Let us separate data with months 1,3 and 7
...
```{r order, fig.width=6, fig.height=3,fig.show='hold',fig.align='center'}
